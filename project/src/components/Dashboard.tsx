...
const LiveStreakCounter: React.FC<LiveStreakCounterProps> = ({ streakStartDate, onRestart, onShowHistory }) => {
    ...
    <div className="relative">
      ...
      <div className="relative w-80 h-80 mx-auto rounded-full overflow-hidden shadow-2xl">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={onRestart}
          className="absolute bottom-4 right-4 w-12 h-12 bg-red-500 hover:bg-red-600 rounded-full flex items-center justify-center text-white shadow-lg transition-colors"
        ...
        <motion.button
          ...
          className="absolute bottom-4 left-4 w-12 h-12 bg-orange-500 hover:bg-orange-600 rounded-full flex items-center justify-center text-white shadow-lg transition-colors"
